    ...
    <div className="grid">
      <div className="step">
        <h3 className="step-title">
          ...
          <span className="label">IN–HOME<br/>CONSULTATION</span>
        </h3>
        <ul>
          <li>Schedule your appointment online or by phone.</li>
          <li>Our mobile specialists visit your home or office at your convenience.</li>
          <li>We evaluate your items on-site and offer immediate payment.</li>
        </ul>
      </div>
      ...
      <div className="step">
        ...
        <ul>
          ...
          <li>Approve and get paid instantly by check, direct deposit, or wire.</li>
        </ul>
      </div>
    </div>
  </div>
